...
@echo +++++++++++++++++++++++++ %~1 %~2 %~3
msbuild /m "/p:Configuration=%~1;Platform=%~2" /t:Clean /consoleLoggerParameters:Summary /verbosity:minimal /fileLogger "/fileLoggerParameters:Summary;PerformanceSummary;Append;Verbosity=normal;LogFile=%~dp0build\audacity_%~1_%~2_%~3.log" top.proj
@if %errorlevel% neq 0 goto errorexit
@echo ------------------------- %~1 %~2 %~3
